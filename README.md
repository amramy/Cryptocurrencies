...
* fit_transform() pca components.
* Create DataFrame with the three principle components.
...
* Create a new DataFrame with tradable cryptocurrencies and index from original dataset.
  * Include the "CoinName" column.
  * Include the "Class" column.
* Create a hvplot.scatter using x="TotalCoinsMined" and y="TotalCoinSupply" from the newest DataFrame.
